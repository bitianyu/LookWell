...
public class GradeServiceImpl implements GradeService {
    ...
    public Integer addGrade(Grade grade) {
        ...
        /*//1.生成班级名称
        String projectName=grade.getArrangingId().getChapterId().getCourseId().getProjectId().getProjectName();
        String gradeName=addGradeName(grade.getGradeId(), projectName);
        //2.班级名称赋值
     ...
     */
    @Override
    public String addGradeName(Integer gradeId, String projectName) {
        //1. max_num自加1
        Integer n = gradeNameMapper.updateNumByGradeId(gradeId);
        //2. 查班级的max_num
        Integer max_num = gradeNameMapper.queryNumByGradeId(gradeId);
